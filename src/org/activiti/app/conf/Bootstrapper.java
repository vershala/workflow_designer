...
public class Bootstrapper implements ApplicationListener<ContextRefreshedEvent> {
  ...
  protected User initializeSuperUser() {
    ...
    // update by Asy - add tenant for user
    String adminTenant = env.getRequiredProperty("admin.tenant");
    String adminfirstname = env.getRequiredProperty("admin.fistname");
