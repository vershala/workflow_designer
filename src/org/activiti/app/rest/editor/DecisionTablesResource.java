...
public class DecisionTablesResource extends AbstractModelsResource {

  @RequestMapping(method = RequestMethod.GET, produces = "application/json")
  public ResultListDataRepresentation getDecisionTables(HttpServletRequest request) {
	  
	  return super.getModels("", "modifiedDesc", AbstractModel.MODEL_TYPE_DECISION_TABLE, request);
  }
}
