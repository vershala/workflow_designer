...
// User service
activitiApp.service('RuntimeAppDefinitionService', ['$http', '$q', '$location','$rootScope', 'AuthenticationSharedService', 'appName',
    function ($http, $q, $location,$rootScope , AuthenticationSharedService, appName) {
        ...
        this.getApplications = function () {
            ...
            var transformAppsResponse = function(value) {
                ...
                // update by Asy - only admin can load all module
            	if($rootScope.account != undefined && $rootScope.account.id != "admin"){
