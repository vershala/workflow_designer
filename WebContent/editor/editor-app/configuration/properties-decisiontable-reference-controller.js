...
angular.module('activitiModeler').controller('ActivitiDecisionTableReferencePopupCtrl', ['$rootScope', '$scope', '$http', '$location', '$timeout',
    function($rootScope, $scope, $http, $location, $timeout) {
        ...
        $scope.loadDecisionTables = function() {
            ...
            $http.get(ACTIVITI.CONFIG.contextRoot + '/app/rest/decision-table-models', {params: params})
                .success(
                    function(response) {
